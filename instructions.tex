...
\begin{lstlisting}[escapechar=@]
gamemoderun gamescope -H @\underline{monitor-height}@ -W @\underline{monitor-width}@ -r @\underline{monitor-refresh-rate}@ -f -e --backend sdl --force-grab-cursor %command%
\end{lstlisting}
...
\begin{itemize}
    ...
    \item \lstinline|-r| takes your monitor's refresh rate in Hz.
